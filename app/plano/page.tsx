    ...
    <main className="flex flex-1 flex-col gap-6 px-4 py-6 max-w-2xl mx-auto w-full">
      <header className="flex flex-col gap-2">
        <h1 className="text-3xl font-semibold leading-tight">
          {batch ? "Plano em andamento" : "Comece um plano"}
        </h1>
        <p className="text-sm text-muted-foreground">
          {batch
            ? "Sugestão de ordem; cozinhe quando quiser."
            : "Você ainda não tem nenhum plano desta semana."}
        </p>
      </header>

      {!batch ? (
        <div className="flex flex-col items-center gap-3 py-8">
          <p className="text-sm text-muted-foreground">Sem plano em andamento.</p>
